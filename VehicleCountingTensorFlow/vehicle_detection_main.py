...
# ----------------------------------------------
# Edited by Peter Sherman, City of Raleigh, 2019-01-14
...
#EDITED PJS - commented out tf version check. 1.4 is older than 1.12
#if tf.__version__ < '1.4.0':
    #raise ImportError('Please upgrade your tensorflow installation to v1.4.* or later!'
                      #)

# input video
# EDITED PJS - changed to my video
#cap = cv2.VideoCapture('pivideo3.mp4')
#cap = cv2.VideoCapture('pivideo3.h264')
#cap = cv2.VideoCapture('iPhoneVideo.mov')
#cap = cv2.VideoCapture('P1033777small.mp4')
cap = cv2.VideoCapture('2019-02-22_07.mp4')
    ...
    with detection_graph.as_default():
        ...
        with tf.Session(graph=detection_graph) as sess:
            ...
            while cap.isOpened():
                ...
                input_frame = frame
                #EDITED PJS - flip frame for iphone video
                #cv.Flip(frame, flipMode=-1) #didn't work, using cv2, not cv
